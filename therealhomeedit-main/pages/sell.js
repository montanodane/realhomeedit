...
import HubspotSellForm from "../components/hubspotsellform";
import ReactMarkdown from "react-markdown";
import Image from "next/image";
import LogoBg from "../public/images/edits-gallery-logo-bg.png";

export default function Sell({ locations, edits, pagesettings, sociallinks }) {
    const seo = {
        ...pagesettings.SEO,
    };
            ...
            <section className="relative w-full relative bg-[#B4B5AC] text-[#202020] py-10">
                ...
                <div className="xl:container xl:mx-auto lg:px-10 px-5">
                    <div className="mb-24 max-w-[600px] mx-auto ">
                        <h2>Request a valuation of your property</h2>
                        <HubspotSellForm />
                    </div>
...
export async function getStaticProps() {
    ...
    const page_res = await fetch(`${config.STRAPI_URL}/sell`);
